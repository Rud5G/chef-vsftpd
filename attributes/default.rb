...
default['vsftpd']['config']['dirmessage_enable'] = true
...
default['vsftpd']['config']['ssl_enable'] = true
if node['vsftpd']['config']['ssl_enable']
  default['vsftpd']['config']['require_ssl_reuse'] = false
  default['vsftpd']['config']['ssl_cert_path'] = '/etc/ssl/certs'
  default['vsftpd']['config']['rsa_cert_file'] = 'ssl-cert-snakeoil.pem'
  default['vsftpd']['config']['ssl_private_key_path'] = '/etc/ssl/private'
  default['vsftpd']['config']['rsa_private_key_file'] = 'ssl-cert-snakeoil.key'
...
if node['vsftpd']['virtual_users_enable']
  ...
  default['vsftpd']['config']['guest_home'] = '/home/ftpsite'
  default['vsftpd']['config']['guest_enable'] = true
  default['vsftpd']['config']['user_config_dir'] = '/etc/vsftpd/users'
  default['vsftpd']['config']['user_passwd_file'] = '/etc/vsftpd/login.db'
  default['vsftpd']['config']['user_passwd_type'] = 'db'
